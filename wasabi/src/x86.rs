...
///    push - // No error code
///    push rcx // Save rcx first to resure
///    mov rcx, N // INT#
...
impl TaskStateSegment64Descriptor {
    const fn new(base_addr: u64) -> Self {
        Self {
            limit_low: size_of::<TaskStateSegment64Descriptor>() as u16,
            ...
            base_hight: ((base_addr >> 32) & 0xffffffff) as u32,
            reserved: 0,
        }
    }
}
...
/// instance of the reference exits at every moment.
