...
fn extract_bits_test() {
  ...
  assert_eq!(extract_bits(0x1234_5678_1234_5678, 60, 4), 0x1u64);
  assert_eq!(extract_bits(0x1234_5678_1234_5678, 60, 0), 0x0u64);
  assert_eq!(extract_bits(0x1234_5678_1234_5678, 0, 64),
   0x1234_5678_1234_5678u64
  );
  assert_eq!(extract_bits(0x1234_5678_1234_5678, 0, 65), 
   0x1234_5678_1234_5678u64
  );
}